...
└── _docs/                 # Repositório centralizado de documentação
  ├── ARCHITECTURE.md    # Arquitetura e detalhes técnicos
...
| Item                     | Obrigatoriedade          | Propósito                                                                  |
| ------------------------ | ------------------------ | -------------------------------------------------------------------------- |
| `README.md`              | **Obrigatório**          | Apresentação, onboarding e links para demais docs.                         |
| `_docs/ARCHITECTURE.md`  | **Obrigatório**          | Arquitetura completa, stack, padrões e guia de implementação.              |
...
Veja modelo completo em `blueprint-doc-README-model.md`.
...
O `_docs/ARCHITECTURE.md` é o documento de referência técnica profunda do projeto. Destina-se a desenvolvedores que precisam entender, manter ou evoluir o sistema.

### 5.1 Estrutura Obrigatória do ARCHITECTURE.md

Veja modelo completo em `blueprint-doc-ARCHITETURE-model.md`.

---

## 6. Pasta `_docs` — Documentação do Projeto

Toda documentação técnica (incluindo o `ARCHITECTURE.md`) deve residir na pasta `_docs`, **organizada por onda de desenvolvimento**. Cada onda possui seus próprios subdiretórios temáticos, garantindo isolamento total entre os ciclos de entrega.
...
Veja modelo completo em `blueprint-doc-escopo-model.md`.

### 6.4 Template de Ata de Reunião

Veja modelo completo em `blueprint-doc-ata-model.md`.

### 6.5 Template de ADR (Architecture Decision Record)

Veja modelo completo em `blueprint-doc-adr-model.md`.
...
- [ ] Descreve o estilo arquitetural adotado.
...
- [ ] Documenta os principais componentes/módulos.
...
2. Crie o `_docs/ARCHITECTURE.md` seguindo o template da seção 5.
3. No `_docs/ARCHITECTURE.md`, preencha a seção "Histórico de Ondas" mapeando o que foi entregue em cada ciclo até o momento.
4. Verifique se o linter não aponta erros críticos nos dois arquivos.
